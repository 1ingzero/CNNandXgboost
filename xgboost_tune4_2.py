...
#定义'subsample'和'colsample_bytree'的跨度更小的寻优函数
if __name__=='__main__':
    ...
    param_test4_2 = {   'colsample_bytree':list([i/100.0 for i in range(75,90,5)]),
                        'subsample':list([i/100.0 for i in range(75,90,5)])      }

    gsearch4_2 = GridSearchCV( estimator = XGBClassifier( learning_rate =0.1, n_estimators=500, max_depth=7,
    ...
    print_best_score(gsearch4_2,param_test4_2)