...
if __name__=='__main__':
    ...
    param_test6= {   'reg_alpha':list([1e-5, 1e-2, 0.1, 1, 100])}

    gsearch6 = GridSearchCV( estimator = XGBClassifier( learning_rate =0.1, n_estimators=981, max_depth=6,
    ...
    print_best_score(gsearch6,param_test6)